...
void drawScene(){
	...
	glPushMatrix();		
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); 					glVertex3i( 0,   0, quintalL); 
			glTexCoord2f(repeatPH*1.0f,0.0f); 			glVertex3i( quintalC,  0, quintalL); 
			glTexCoord2f(repeatPH*1.0f,repeatPH*1.0f); 	glVertex3i( quintalC, 0, 0); 
	...
	glPushMatrix();
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); 					glVertex3i( 0, 0, quintalL+relvaL); 
			glTexCoord2f(repeatPH*1.0f,0.0f); 			glVertex3i( relvaC,  0, quintalL+relvaL); 
			glTexCoord2f(repeatPH*1.0f,repeatPH*1.0f); 	glVertex3i( relvaC, 0, quintalL); 
			glTexCoord2f(0.0f,repeatPH*1.0f); 			glVertex3i( 0, 0, quintalL); 
		glEnd();
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
	...
	glPushMatrix();		
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); 					glVertex3i(quintalC , 0, terraL-relvaL); 
			glTexCoord2f(repeatPH2*1.0f,0.0f); 			glVertex3i( quintalC+terraC,  0, terraL-relvaL); 
			glTexCoord2f(repeatPH2*1.0f,repeatPH2*1.0f); 	glVertex3i( quintalC+terraC, 0,-relvaL); 
			glTexCoord2f(0.0f,repeatPH2*1.0f); 			glVertex3i( quintalC, 0, -relvaL); 
		glEnd();
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
	...
	glPushMatrix();		
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f,0.0f); glVertex3i( -salaC,   0, salaC*2); 
			glTexCoord2f(1.0f,0.0f); glVertex3i( 0,  0, salaC*2); 
			glTexCoord2f(1.0f,1.0f); glVertex3i( 0, 0, -salaC); 
			glTexCoord2f(0.0f,1.0f); glVertex3i( -salaC, 0, -salaC); 
		glEnd();
	glPopMatrix();
	glDisable(GL_TEXTURE_2D);
	...
	*/
	...
	if(continua && joga){
		...
		if((pl1_pos1 ==1) && (pl1_pos2 == 1) && (pl1_pos3 == 1)){
			...
			desenhavencedor(texto, -16.1,5,11);
			continua = 0;
			glPopMatrix();
		}
	...
	glPushMatrix();
	 drawArvore(30,10,quintalL+relvaL,10,10,1);
	drawArvore(40,10,quintalL+relvaL,10,10,1);
	drawArvore(20,10,quintalL+relvaL,10,10,1);
	drawArvore(15,10,quintalL+relvaL,10,10,1);
	drawArvore(10,10,quintalL+relvaL,10,10,1);
	drawArvore(30,10,quintalL,10,10,1);
	drawArvore(20,10,quintalL,10,10,1);
	drawArvore(15,10,quintalL,10,10,1);
	drawArvore(10,10,quintalL,10,10,1);
	drawArvore(5,10,quintalL,10,10,1);
	 glPopMatrix();
...
void teclasNotAscii(int key, int x, int y){
	...
	if(key == GLUT_KEY_UP){
	    ...
	    if(obsPini[2]-incVisao*sin(aVisao)>-19  && obsPini[2]-incVisao*sin(aVisao)<39 )
	...
	if(key == GLUT_KEY_DOWN){
		...
		if(obsPini[0]-incVisao*sin(aVisao)>-29  && obsPini[0]-incVisao*sin(aVisao)<-1 )
			obsPini[0]=obsPini[0]-incVisao*cos(aVisao); 
		if(obsPini[2]+incVisao*cos(aVisao)>-19 && obsPini[2]+incVisao*cos(aVisao)<39 )
			obsPini[2]=obsPini[2]+incVisao*sin(aVisao);	
	} 
