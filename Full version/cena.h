...
GLfloat   quintalC=40.0;				//comprimento do quintal
GLfloat   quintalL=20.0;				//largura do quintal
GLfloat   quintalP[]= {40, 0, 10};		//posiaçao do quintal


GLfloat   salaC=30.0;				//comprimento da sala
GLfloat   salaL=60.0;				//largura da sala
GLfloat   salaP[]= {40, 0, 10};		//posiaçao da sala
...
GLfloat focoConc = 100.0;					//concentração de luz [0;128]
...
GLfloat foco2ang = 100.0;			//angulo 0-90
